...
pub fn set_method(val: &str) -> Result<(), super::plugin::HostErr> {
...
pub fn set_url(val: &str) -> Result<(), super::plugin::HostErr> {
...
pub fn set_body(val: &str) -> Result<(), super::plugin::HostErr> {
...
pub fn set_body_field(key: &str, val: &str) -> Result<(), super::plugin::HostErr> {
...
pub fn set_header(key: &str, val: &str) -> Result<(), super::plugin::HostErr> {
...
pub fn set_url_param(key: &str, val: &str) -> Result<(), super::plugin::HostErr> {
...
pub fn set_state(key: &str, val: &str) -> Result<(), super::plugin::HostErr> {
...
fn set_field(field_type: i32, key: &str, val: &str) -> Result<(), super::plugin::HostErr> {
